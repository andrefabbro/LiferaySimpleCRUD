...
import com.liferay.smartstore.service.NoSuchMobilePhoneException;
import com.liferay.smartstore.service.model.MobilePhone;
import com.liferay.smartstore.service.model.impl.MobilePhoneImpl;
import com.liferay.smartstore.service.model.impl.MobilePhoneModelImpl;
...
public class MobilePhonePersistenceImpl extends BasePersistenceImpl<MobilePhone>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_NAME = new FinderPath(MobilePhoneModelImpl.ENTITY_CACHE_ENABLED,
			MobilePhoneModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public List<MobilePhone> findByName(String name, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (MobilePhone mobilePhone : list) {
				if (!StringUtil.wildcardMatches(mobilePhone.getName(), name,
	...
	private static final String _FINDER_COLUMN_NAME_NAME_1 = "mobilePhone.name LIKE NULL";
	private static final String _FINDER_COLUMN_NAME_NAME_2 = "mobilePhone.name LIKE ?";
	private static final String _FINDER_COLUMN_NAME_NAME_3 = "(mobilePhone.name IS NULL OR mobilePhone.name LIKE '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_BRAND = new FinderPath(MobilePhoneModelImpl.ENTITY_CACHE_ENABLED,
			MobilePhoneModelImpl.FINDER_CACHE_ENABLED, MobilePhoneImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_BRAND = new FinderPath(MobilePhoneModelImpl.ENTITY_CACHE_ENABLED,
			MobilePhoneModelImpl.FINDER_CACHE_ENABLED, MobilePhoneImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByBrand",
			new String[] { String.class.getName() },
			MobilePhoneModelImpl.BRAND_COLUMN_BITMASK |
			MobilePhoneModelImpl.RELEASEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_BRAND = new FinderPath(MobilePhoneModelImpl.ENTITY_CACHE_ENABLED,
			MobilePhoneModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<MobilePhone> findByBrand(String brand)
		throws SystemException {
	 ...
	 */
	@Override
	public List<MobilePhone> findByBrand(String brand, int start, int end)
		throws SystemException {
	...
	public List<MobilePhone> findByBrand(String brand, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (MobilePhone mobilePhone : list) {
				if (!Validator.equals(brand, mobilePhone.getBrand())) {
					list = null;
	 ...
	 */
	@Override
	public MobilePhone findByBrand_First(String brand,
		OrderByComparator orderByComparator)
		throws NoSuchMobilePhoneException, SystemException {
		MobilePhone mobilePhone = fetchByBrand_First(brand, orderByComparator);
	 ...
	 */
	@Override
	public MobilePhone fetchByBrand_First(String brand,
		OrderByComparator orderByComparator) throws SystemException {
		List<MobilePhone> list = findByBrand(brand, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public MobilePhone findByBrand_Last(String brand,
		OrderByComparator orderByComparator)
		throws NoSuchMobilePhoneException, SystemException {
		MobilePhone mobilePhone = fetchByBrand_Last(brand, orderByComparator);
	 ...
	 */
	@Override
	public MobilePhone fetchByBrand_Last(String brand,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<MobilePhone> list = findByBrand(brand, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public MobilePhone[] findByBrand_PrevAndNext(long id, String brand,
		OrderByComparator orderByComparator)
		throws NoSuchMobilePhoneException, SystemException {
		MobilePhone mobilePhone = findByPrimaryKey(id);
		...
		try {
			...
			array[0] = getByBrand_PrevAndNext(session, mobilePhone, brand,
					orderByComparator, true);

			array[1] = mobilePhone;

			array[2] = getByBrand_PrevAndNext(session, mobilePhone, brand,
					orderByComparator, false);
	...
	protected MobilePhone getByBrand_PrevAndNext(Session session,
		MobilePhone mobilePhone, String brand,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByBrand(String brand) throws SystemException {
		for (MobilePhone mobilePhone : findByBrand(brand, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(mobilePhone);
		}
	}
	...
	private static final String _FINDER_COLUMN_BRAND_BRAND_1 = "mobilePhone.brand IS NULL";
	private static final String _FINDER_COLUMN_BRAND_BRAND_2 = "mobilePhone.brand = ?";
	private static final String _FINDER_COLUMN_BRAND_BRAND_3 = "(mobilePhone.brand IS NULL OR mobilePhone.brand = '')";
		...
		if (isNew || !MobilePhoneModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((mobilePhoneModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						mobilePhoneModelImpl.getOriginalBrand()
					};
				...
				args = new Object[] { mobilePhoneModelImpl.getBrand() };
	...
	protected MobilePhone toUnwrappedModel(MobilePhone mobilePhone) {
		...
		mobilePhoneImpl.setCompanyId(mobilePhone.getCompanyId());
		mobilePhoneImpl.setUserId(mobilePhone.getUserId());
		mobilePhoneImpl.setUserName(mobilePhone.getUserName());
		mobilePhoneImpl.setCreateDate(mobilePhone.getCreateDate());
		mobilePhoneImpl.setModifiedDate(mobilePhone.getModifiedDate());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.smartstore.service.model.MobilePhone")));
